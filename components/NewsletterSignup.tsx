  ...
  return (
    ...
    >
      ...
      <div
        ...
        aria-hidden="true"
        style={{
          backgroundImage: "radial-gradient(ellipse 80% 50% at 50% 50%, #E8621A, transparent)",
        }}
      />
      ...
      <div className="relative z-10 max-w-2xl mx-auto text-center">
        ...
        {status === "success" ? (
          ...
          <>
            ...
            {status === "error" && (
              <p className="font-barlow text-xs text-brand-red mt-2 tracking-wide animate-fade-in">
                Please enter a valid email address.
              </p>
            )}

            <p className="font-barlow text-[10px] text-brand-white/25 tracking-wide mt-6 leading-relaxed">
              By signing up you agree to receive marketing emails. Unsubscribe at any time. We respect your privacy.
            </p>
          </>
        )}
      </div>
