...
export const metadata: Metadata = {
  ...
  title: {
    default:  "Sworn In USA | Bold American Klothing",
  ...
  keywords: [
    ...
    "American klothing",
    "patriotic apparel",
    "American made klothing",
    "hoodies",
    "graphic tees",
    "American pride klothing",
    "bold American brand",
    "sworn in klothing",
    "patriot klothing brand",
  ],
  ...
  openGraph: {
    ...
    description: "Bold American klothing for people who know exactly who they are. Put your money where your pride is.",
    images: [
      {
        url:    "/images/og-image.jpg",
        width:  1200,
        height: 630,
        alt:    "Sworn In USA - Bold American Klothing",
      },
    ],
  },
  twitter: {
